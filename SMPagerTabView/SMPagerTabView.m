...
- (UIColor *)tabButtonTitleColorForSelected {
    if (!_tabButtonTitleColorForSelected) {
        self.tabButtonTitleColorForSelected = [UIColor blackColor];
    }
...
- (UIView *)selectedLine {
    if (!_selectedLine) {
        ...
        _selectedLine.backgroundColor = [UIColor colorWithRed:1.000 green:0.867 blue:0.306 alpha:1.00];
