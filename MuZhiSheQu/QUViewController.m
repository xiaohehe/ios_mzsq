...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    FindeshViewController *city = [FindeshViewController new];
    city.ID=_data[indexPath.row][@"id"];
    
    [[NSUserDefaults standardUserDefaults]setObject:_data[indexPath.row][@"name"] forKey:@"GuidequName"];
    [[NSUserDefaults standardUserDefaults]setObject:_data[indexPath.row][@"id"] forKey:@"GuidequId"];
