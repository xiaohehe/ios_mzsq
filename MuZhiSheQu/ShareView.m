    ...
    switch (type) {
        ...
        case JSHARELink:
            [self.currentContentSupportPlatform addObjectsFromArray:@[@(JSHAREPlatformWechatSession),
                                                                      ...
                                                                      //@(JSHAREPlatformWechatFavourite),
                                                                      @(JSHAREPlatformQQ),
                                                                      @(JSHAREPlatformQzone)]];//@(JSHAREPlatformSinaWeibo),@(JSHAREPlatformFacebook),@(JSHAREPlatformFacebookMessenger)
...
- (void)showWithSupportedLoginPlatform{
    ...
    [self.currentContentSupportPlatform removeAllObjects];
    [self.currentContentSupportPlatform addObjectsFromArray:@[@(JSHAREPlatformWechatSession),@(JSHAREPlatformQQ),@(JSHAREPlatformSinaWeibo),@(JSHAREPlatformFacebook)]];
    [self setShareItem];
    self.hidden = NO;
}
...
- (void)setPlatformDataWithLogin:(BOOL)isLogin {
    ...
    if(isLogin){
        titleArr = @[@"新浪微博",@"微信",@"微信朋友圈",@"微信收藏",@"QQ",@"QQ空间",@"Facebook",@"Messenger"];
    }else {
        titleArr = @[@"新浪微博",@"微信好友",@"微信朋友圈",@"微信收藏",@"QQ好友",@"QQ空间",@"Facebook",@"Messenger"];
    }
    NSArray * imageArr = @[@"weibo",@"wechat",@"wechat_moment",@"wechat_fav",@"qq",@"qzone",@"facebook",@"messenger"];
