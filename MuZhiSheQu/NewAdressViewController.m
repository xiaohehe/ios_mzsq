...
-(void)SaveBtnVC:(id)sender{
   ...
   // NSString *adress = [_xiaoqux.text stringByAppendingString:_dizhix.text];
    ...
    NSDictionary *dic = @{@"user_id":userid,@"real_name":_nameTF.text,@"sex":_sex,@"house_number":_dizhix.text,@"address":_xiaoqux.text,@"mobile":_shoujix.text,@"lng":[NSString stringWithFormat:@"%@",_jing],@"lat":[NSString stringWithFormat:@"%@",_wei]};
