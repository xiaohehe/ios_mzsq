...
@interface CommQuViewController ()<UITableViewDataSource,UITableViewDelegate>
@property(nonatomic,strong)NSMutableArray *data;
@property(nonatomic,strong)UITableView *table;
@end

@implementation CommQuViewController
...
//    [_data removeAllObjects];
    ...
    NSDictionary *dic = @{@"district_id":self.ID};
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"commqu" object:_data[indexPath.row]];
    //commid
    ...
    [nale getGJidWithDic:@{@"community_id":_data[indexPath.row][@"id"]} Block:^(id models, NSString *code, NSString *msg) {
        if ([models isKindOfClass:[NSDictionary class]]) {
            ...
            //                [[NSUserDefaults standardUserDefaults]setObject:@"1" forKey:@"contype"];
