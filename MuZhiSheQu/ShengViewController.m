...
@interface ShengViewController ()<UITableViewDelegate,UITableViewDataSource>
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"sheng" object:_data[indexPath.row]];
