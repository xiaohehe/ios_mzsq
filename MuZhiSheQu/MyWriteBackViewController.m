...
static const NSUInteger PRAISE_TAG = 30000;
@interface MyWriteBackViewController ()<UITableViewDataSource,UITableViewDelegate,PassValueDelegate>
...
@implementation MyWriteBackViewController
...
-(void)reshData{
    ...
    [anle getMyReplyList:dic Block:^(id models, NSString *code, NSString *msg) {
