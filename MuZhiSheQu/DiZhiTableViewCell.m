...
-(void)layoutSubviews{
    ...
    _AdressLabel.frame=CGRectMake(10*self.scale, 10*self.scale, self.width-20*self.scale, [self Text:_AdressLabel.text Size:CGSizeMake(self.width-20*self.scale, 35*self.scale) Font:_AdressLabel.font].height);
    _NameLabel.frame=CGRectMake(10*self.scale,_AdressLabel.bottom+10*self.scale , self.width-60*self.scale, 20*self.scale);
